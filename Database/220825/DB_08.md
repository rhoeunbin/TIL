...
for movie_ in movies:
    movie = Movie()
    director_ = Director.objects.get(name=movie_[0])
    genre_ = Genre.objects.get(title=movie_[1])
    title_ = movie_[2]
    opening_date_ = movie_[3]
    running_time_ = movie_[4]
    screening_ = movie_[5]
...
```python
director_ = Director.objects.get(name='봉준호').id
